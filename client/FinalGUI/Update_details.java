...
public class Update_details extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jPanel3.setBorder(
      javax.swing.BorderFactory.createTitledBorder(
        ...
        new java.awt.Font("Century Gothic", 0, 50),
    ...
    jPanel3.add(
      jLabel12,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 190, -1, -1)
    );
    ...
    jPanel3.add(
      jLabel13,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 250, -1, -1)
    );
    ...
    jPanel3.add(
      jLabel14,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 310, -1, -1)
    );
    ...
    jPanel3.add(
      update_email,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 250, 190, -1)
    );
    ...
    jPanel3.add(
      update_name,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 190, 190, -1)
    );
    ...
    jPanel3.add(
      update_gr,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 310, 190, -1)
    );
    ...
    jPanel3.add(
      jLabel15,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 370, -1, -1)
    );
    ...
    jPanel3.add(
      jLabel16,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 420, -1, -1)
    );
    ...
    jPanel3.add(
      jLabel17,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 480, -1, -1)
    );
    ...
    jPanel3.add(
      update_roll,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 470, 190, -1)
    );
    ...
    jPanel3.add(
      jLabel18,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 270, -1, -1)
    );
    ...
    jPanel3.add(
      jPasswordFieldregister1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 260, 190, -1)
    );
    ...
    update_year.setModel(
      new javax.swing.DefaultComboBoxModel<>(
        new String[] { "FE", "SE", "TE", "BE" }
      )
    );
    update_year.setToolTipText("");
    update_year.addActionListener(
      new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jPanel3.add(
      update_year,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 370, 190, -1)
    );
    ...
    update_class.setModel(
      new javax.swing.DefaultComboBoxModel<>(
        new String[] { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J" }
      )
    );
    update_class.addActionListener(
      new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jPanel3.add(
      update_class,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 420, 190, -1)
    );
    ...
    jPanel3.add(
      jSeparator10,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 290, 190, 10)
    );
    ...
    jPanel3.add(
      jSeparator16,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 340, 190, 10)
    );
    ...
    jPanel3.add(
      jSeparator17,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 500, 190, 10)
    );
    ...
    jPanel3.add(
      jLabel20,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 330, -1, -1)
    );

    jPasswordconfirmregister2.setFont(
      new java.awt.Font("Century Gothic", 1, 16)
    ); // NOI18N
    jPasswordconfirmregister2.setForeground(new java.awt.Color(0, 102, 255));
    jPasswordconfirmregister2.setBorder(null);
    jPanel3.add(
      jPasswordconfirmregister2,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 330, 190, -1)
    );
    ...
    jPanel3.add(
      jSeparator18,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 360, 190, 10)
    );
    ...
    jPanel3.add(
      jLabel21,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 110, 410, 40)
    );
    ...
    jPanel3.add(
      jSeparator19,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 220, 190, 10)
    );
    ...
    jPanel3.add(
      jLabel22,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, 350, 40)
    );
    jPanel3.add(
      jSeparator3,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 170, -1, -1)
    );
    jPanel3.add(
      jSeparator4,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 160, -1, -1)
    );
    ...
    jPanel3.add(
      jSeparator20,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 280, 190, 10)
    );
    ...
    jPanel3.add(
      jupdate1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 620, 210, 40)
    );
    ...
    jPanel3.add(
      reset1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 620, 210, 40)
    );

    jLabel1.setIcon(
      new javax.swing.ImageIcon(
        getClass()
          .getResource("/FinalGUI/20 Google Material Design HD Wallpapers.jpg")
      )
    ); // NOI18N
    jLabel1.setText("jLabel1");
    jPanel3.add(
      jLabel1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -550, 120, -1)
    );
    ...
    jPanel3.add(
      reset2,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 620, 210, 40)
    );
  ...
  private void update_namejName1ActionPerformed(
    java.awt.event.ActionEvent evt
  ) { //GEN-FIRST:event_update_namejName1ActionPerformed
    // TODO add your handling code here:
  } //GEN-LAST:event_update_namejName1ActionPerformed

  private void update_nameMouseClicked(java.awt.event.MouseEvent evt) {} //GEN-FIRST:event_update_nameMouseClicked //GEN-LAST:event_update_nameMouseClicked

  private void update_nameFocusGained(java.awt.event.FocusEvent evt) {} //GEN-FIRST:event_update_nameFocusGained //GEN-LAST:event_update_nameFocusGained
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger
        .getLogger(Update_details.class.getName())
