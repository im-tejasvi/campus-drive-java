...
public class Homepage extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jPanel1.setBorder(
      javax.swing.BorderFactory.createTitledBorder(
        ...
        new java.awt.Font("Century Gothic", 0, 54),
    ...
    jTextUpload.setBorder(
      javax.swing.BorderFactory.createTitledBorder(
        null,
        "FILE PATH",
        javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        javax.swing.border.TitledBorder.DEFAULT_POSITION,
        new java.awt.Font("Century Gothic", 2, 12)
      )
    ); // NOI18N
    jTextUpload.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
    jTextUpload.addActionListener(
    ...
    jPanel1.add(
      jTextUpload,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 520, 610, -1)
    );
    ...
    jPanel1.add(
      jScrollPane1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 120, 510, 450)
    );
    ...
    jPanel1.add(
      jLabel1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 120, 750)
    );
    ...
    jPanel1.add(
      jDownload,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 370, 250, 60)
    );
    ...
    jPanel1.add(
      jUpdate,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 200, 250, 60)
    );
    ...
    jPanel1.add(
      jUpload,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 570, 250, 47)
    );
    ...
    jPanel1.add(
      jUpload1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 370, 240, 60)
    );

    jLabel3.setIcon(
      new javax.swing.ImageIcon(
        getClass().getResource("/FinalGUI/icons8-Download-70.png")
      )
    ); // NOI18N
    jPanel1.add(
      jLabel3,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 290, 70, 70)
    );

    jLabel5.setIcon(
      new javax.swing.ImageIcon(
        getClass().getResource("/FinalGUI/icons8-Upload-70.png")
      )
    ); // NOI18N
    jPanel1.add(
      jLabel5,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 290, 80, 80)
    );

    jLabel6.setIcon(
      new javax.swing.ImageIcon(
        getClass().getResource("/FinalGUI/icons8-Update Filled-70.png")
      )
    ); // NOI18N
    jPanel1.add(
      jLabel6,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, 70, 70)
    );

    jLabel7.setIcon(
      new javax.swing.ImageIcon(
        getClass().getResource("/FinalGUI/icons8-Delete-70.png")
      )
    ); // NOI18N
    jPanel1.add(
      jLabel7,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 120, 80, 80)
    );
    ...
    jPanel1.add(
      jjlogin1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 610, 180, 40)
    );

    progress_bar_up.setOpaque(true);
    jPanel1.add(
      progress_bar_up,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 440, 170, 20)
    );

    progress_bar_dwn.setOpaque(true);
    jPanel1.add(
      progress_bar_dwn,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 440, 170, 20)
    );
  ...
  private void jDownloadActionPerformed(java.awt.event.ActionEvent evt) { //GEN-FIRST:event_jDownloadActionPerformed
    try {
      if (Homepage.file_table.getCellSelectionEnabled()) {
        ...
        String value = file_table
          .getModel()
          .getValueAt(rowIndex, column)
          .toString();
        ...
        JOptionPane.showMessageDialog(
          this,
          "File will be downloaded in the background..."
        );
        new FileShare.Download(Connection.ConnectToServer.socket, value)
          .start();
      } else {
        JOptionPane.showMessageDialog(
          this,
          "   Please select a file from the table to download     ".toUpperCase()
        );
      }
    } catch (Exception e) {
  ...
  private void jUpload1ActionPerformed(java.awt.event.ActionEvent evt) { //GEN-FIRST:event_jUpload1ActionPerformed
    ...
    if (FILE_TO_SEND.equals("")) {
      ...
      Connection.ConnectToServer.connect_to_server();
      jTextUpload.setText("");
      new FileShare.Upload(Connection.ConnectToServer.socket, FILE_TO_SEND)
        .start();
    }
  ...
  private void jDeleteActionPerformed(java.awt.event.ActionEvent evt) { //GEN-FIRST:event_jDeleteActionPerformed
    try {
      if (Homepage.file_table.getCellSelectionEnabled()) {
        ...
        JOptionPane.showMessageDialog(
          this,
          "   Please select a file to delete form table     ".toUpperCase()
        );
      }
    } catch (Exception e) {
      if (file_table.getRowCount() == 0) JOptionPane.showMessageDialog(
        this,
        "No files to delete"
      ); else JOptionPane.showMessageDialog(
        this,
