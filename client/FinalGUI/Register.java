...
public class Register extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jPanel3.add(
      juserid1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 240, 190, -1)
    );
    ...
    jPanel3.add(
      jLabel18,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 320, -1, -1)
    );
    ...
    jPanel3.add(
      jLabel19,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 240, -1, -1)
    );
    ...
    jPanel3.add(
      ...
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 310, 190, -1)
    );
    ...
    jPanel3.add(
      jSeparator9,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 270, 190, 10)
    );
    ...
    jPanel3.add(
      jSeparator10,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 340, 190, 10)
    );
    ...
    jPanel3.add(
      jLabel20,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 380, -1, -1)
    );
    ...
    jPanel3.add(
      ...
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 380, 190, -1)
    );
    ...
    jPanel3.add(
      jSeparator18,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 410, 190, 10)
    );
    ...
    jPanel3.add(
      jLabel21,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 110, 450, 40)
    );
    ...
    jPanel3.add(
      jLabel22,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, 280, 40)
    );
    jPanel3.add(
      jSeparator3,
    ...
    jPanel3.add(
      save1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 580, 180, 40)
    );
    ...
    jPanel3.add(
      reset1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 580, 180, 40)
    );
    ...
    jPanel3.add(
      jjlogin1,
      new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 580, 180, 40)
    );
  ...
  private void save1saveActionPerformed(java.awt.event.ActionEvent evt) { //GEN-FIRST:event_save1saveActionPerformed
    ...
    if (
      ...
      JOptionPane.showMessageDialog(
        this,
        "No Special characters allowed in user id except '_' "
      );
    } else if (user.length() < 5 || passwordconfirm.length() < 6) {
      JOptionPane.showMessageDialog(
        this,
        "User id should contain atleast 5 character\nPassword should contain atleast 6 characters"
      );
      ...
      try {
        ...
        if (!check) {
          JOptionPane.showMessageDialog(
            this,
            "Registration Unsuccesfull.....Details Invalid"
          );
        } else {
          reset();
          ...
          JOptionPane.showMessageDialog(
            this,
            "Registration Successfull... Folder for Download created....\nLogin to continue"
          );
